...
def build_matrix_atomic_attacks(
    *,
    ...
    strategy_converters: dict[str, list[Converter]] | None = None,
    extra_factories: dict[str, AttackTechniqueFactory] | None = None,
) -> list[AtomicAttack]:
    """
    ...
    Args:
        ...
        strategy_converters (dict[str, list[Converter]] | None): Optional mapping from
    ...
    def build(
        ...
        *,
        ...
        Args:
            ...
            strategy_converters (dict[str, list[Converter]] | None): Optional mapping
