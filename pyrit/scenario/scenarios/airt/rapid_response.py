...
from pyrit.scenario.core.dataset_configuration import MultiDatasetAttackConfiguration
    ...
    def __init__(
        ...
        *,
        ...
        super().__init__(
            ...
            default_dataset_config=MultiDatasetAttackConfiguration.per_dataset(
                dataset_names=[
                    "airt_hate",
                    "airt_fairness",
                    "airt_violence",
