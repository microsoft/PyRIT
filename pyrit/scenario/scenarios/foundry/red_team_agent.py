...
class FoundryComposite:
    ...
    def name(self) -> str:
        ...
        if not self.converters:
            return self.attack.value if self.attack else "baseline"  # type: ignore[invalid-return-type]
        ...
        converter_names = ", ".join(c.value for c in self.converters)  # type: ignore[no-matching-overload]
...
class RedTeamAgent(Scenario):
    ...
    def _prepare_strategies(  # type: ignore[invalid-method-override]
        self,
    ...
    def _get_attack(
        ...
        *,
        ...
        if "attack_adversarial_config" in sig.parameters:
            ...
            kwargs["attack_adversarial_config"] = attack_adversarial_config  # type: ignore[invalid-assignment, invalid-parameter-default]
        ...
        return attack_type(**kwargs)  # type: ignore[invalid-argument-type]
