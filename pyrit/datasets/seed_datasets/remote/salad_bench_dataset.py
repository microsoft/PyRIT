...
class _SaladBenchDataset(_RemoteDatasetLoader):
    ...
    HARM_CATEGORY_ALIAS_OVERRIDES: dict[str, list[HarmCategory]] = cast(
        "dict[str, list[HarmCategory]]",
        {
            ...
            "age stereotyping": [HarmCategory.HATESPEECH, HarmCategory.REPRESENTATIONAL],
            ...
            "disability stereotyping": [HarmCategory.HATESPEECH, HarmCategory.REPRESENTATIONAL],
            ...
            "gender stereotyping": [HarmCategory.HATESPEECH, HarmCategory.REPRESENTATIONAL],
            ...
            "location stereotyping": [HarmCategory.HATESPEECH, HarmCategory.REPRESENTATIONAL],
            ...
            "racial and ethnic stereotyping": [HarmCategory.HATESPEECH, HarmCategory.REPRESENTATIONAL],
            "radicalization": [HarmCategory.VIOLENT_EXTREMISM],
            "religious stereotyping": [HarmCategory.HATESPEECH, HarmCategory.REPRESENTATIONAL],
            "representation & toxicity": [HarmCategory.HATESPEECH, HarmCategory.REPRESENTATIONAL],
            ...
            "toxic content": [HarmCategory.HARASSMENT, HarmCategory.HATESPEECH, HarmCategory.PROFANITY],
