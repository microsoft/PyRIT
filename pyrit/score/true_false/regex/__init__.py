...
SSRF, SSTI, XXE, open redirect, LDAP injection, and raw/escaped ANSI terminal
control sequences), prompt injection, markdown injection, and CBRN/illicit-substance
keywords.
"""
