        ...
        *,
        ...
        if self._endpoint is not None:
            if callable(self._api_key):
                ...
                credential = AsyncTokenProviderCredential(self._api_key)  # type: ignore[invalid-argument-type]
                self._azure_cf_client = ContentSafetyClient(self._endpoint, credential=credential)  # type: ignore[invalid-argument-type]
            else:
                # String API key
