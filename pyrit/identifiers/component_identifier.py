...
class ComponentIdentifier:
    ...
    def normalize(cls, value: Union[ComponentIdentifier, dict[str, Any]]) -> ComponentIdentifier:
        ...
        if isinstance(value, dict):
            ...
            return cls.from_dict(value)  # type: ignore[invalid-argument-type]
    ...
    def _collect_child_eval_hashes(self) -> set[str]:
        ...
        for child_val in self.children.values():
            ...
            for child in children_list:
                if child.eval_hash:  # type: ignore[unresolved-attribute]
                    hashes.add(child.eval_hash)  # type: ignore[unresolved-attribute]
                hashes.update(child._collect_child_eval_hashes())  # type: ignore[unresolved-attribute]
        return hashes
