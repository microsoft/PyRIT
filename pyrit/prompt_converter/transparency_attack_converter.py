...
class _AdamOptimizer:
    ...
    by D. P. Kingma and J. Ba, 2014: https://arxiv.org/abs/1412.6980 [@kingma2014adam].
...
class TransparencyAttackConverter(PromptConverter):
    ...
    Note:
        ...
        McKee, F. and Noever, D., 2024: https://arxiv.org/abs/2401.15817 [@mckee2024transparency]
    ...
    async def convert_async(self, *, prompt: str, input_type: PromptDataType = "image_path") -> ConverterResult:
        ...
        Uses the Novel Image Blending Algorithm from: https://arxiv.org/abs/2401.15817 [@mckee2024transparency].
