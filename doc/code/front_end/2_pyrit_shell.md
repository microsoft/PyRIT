...
```bash
pyrit> run red_team_agent --initializers openai_objective_target load_default_datasets
```

### With Strategies

```bash
pyrit> run encoding --initializers openai_objective_target load_default_datasets --strategies base64 rot13

pyrit> run red_team_agent --initializers openai_objective_target load_default_datasets -s jailbreak crescendo
```
...
pyrit> run red_team_agent --initializers openai_objective_target load_default_datasets --max-concurrency 10 --max-retries 3

# Add memory labels for tracking
pyrit> run encoding --initializers openai_objective_target load_default_datasets --memory-labels '{"experiment":"test1","version":"v2"}'
```
...
pyrit> run encoding --initializers openai_objective_target load_default_datasets --database InMemory --log-level DEBUG
```
...
================================================================================
1) red_team_agent --initializers openai_objective_target load_default_datasets --strategies base64
2) encoding --initializers openai_objective_target load_default_datasets --strategies rot13
3) red_team_agent --initializers openai_objective_target load_default_datasets -s jailbreak
================================================================================
...
pyrit> run encoding --strategies base64
pyrit> run encoding --strategies rot13
pyrit> run encoding --strategies morse_code
...
2. **Use short strategy aliases** with `-s`:
   ```bash
   pyrit> run red_team_agent --initializers openai_objective_target load_default_datasets -s base64 rot13
   ```
