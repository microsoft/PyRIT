...
#
# > **Tip:** Crescendo is often the strongest first step in an adaptive fallback chain. See the [Sequential Attack notebook](14_sequential.ipynb) for an example that runs Crescendo first and falls back to `PromptSendingAttack` if it doesn't succeed.
#
#
