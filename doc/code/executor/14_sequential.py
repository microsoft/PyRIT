...
# the convention used in the [Crescendo notebook](10_crescendo.ipynb).
...
#
# This is the canonical use case. We run [`CrescendoAttack`](10_crescendo.ipynb)
# first because multi-turn attacks tend to elicit harmful content more reliably,
# then fall back to [`PromptSendingAttack`](2_prompt_sending.ipynb) for a
