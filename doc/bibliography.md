...
- **Anay Mehrotra, Manolis Zampetakis, Paul Kassianik, Blaine Nelson, Hyrum Anderson, Yaron Singer, Amin Karbasi.** "Tree of Attacks: Jailbreaking Black-Box LLMs Automatically." (TAP) *arXiv:2312.02119*, 2023. [Paper](https://arxiv.org/abs/2312.02119)

- **Jiahao Yu, Xingwei Lin, Zheng Yu, Xinyu Xing.** "GPTFuzzer: Red Teaming Large Language Models with Auto-Generated Jailbreak Prompts." *arXiv:2309.10253*, 2023. [Paper](https://arxiv.org/abs/2309.10253) · [Code](https://github.com/sherdencooper/GPTFuzz)

- **Andy Zou, Zifan Wang, J. Zico Kolter, Matt Fredrikson.** "Universal and Transferable Adversarial Attacks on Aligned Language Models." (GCG) *arXiv:2307.15043*, 2023. [Paper](https://arxiv.org/abs/2307.15043)

- **Alexander Wei, Nika Haghtalab, Jacob Steinhardt.** "Jailbroken: How Does LLM Safety Training Fail?" *arXiv:2307.02483*, 2023. [Paper](https://arxiv.org/abs/2307.02483)

- **Youliang Yuan, Wenxiang Jiao, Wenxuan Wang, Jen-tse Huang, Pinjia He, Shuming Shi, Zhaopeng Tu.** "GPT-4 Is Too Smart To Be Safe: Stealthy Chat with LLMs via Cipher." *arXiv:2308.06463*, 2023. [Paper](https://arxiv.org/abs/2308.06463)

- **Peng Ding, Jun Kuang, Dan Ma, Xuezhi Cao, Yunsen Xian, Jiajun Chen, Shujian Huang.** "A Wolf in Sheep's Clothing: Generalized Nested Jailbreak Prompts can Fool Large Language Models Easily." *arXiv:2311.08268*, 2023. [Paper](https://arxiv.org/abs/2311.08268)

- **Huijie Lv, Xiao Wang, Yuansen Zhang, Caishuang Huang, Shihan Dou, Junjie Ye, Tao Gui, Qi Zhang, Xuanjing Huang.** "CodeChameleon: Personalized Encryption Framework for Jailbreaking Large Language Models." *arXiv:2402.16717*, 2024. [Paper](https://arxiv.org/abs/2402.16717)
...
- **Anthropic.** "Many-Shot Jailbreaking." 2024. [Blog Post](https://www.anthropic.com/research/many-shot-jailbreaking)

- **Microsoft Security Response Center.** "Mitigating Skeleton Key, a New Type of Generative AI Jailbreak Technique." 2024. [Blog Post](https://www.microsoft.com/en-us/security/blog/2024/06/26/mitigating-skeleton-key-a-new-type-of-generative-ai-jailbreak-technique/)

- **Johann Rehberger.** "Hiding and Finding Text with Unicode Tags." Embrace The Red, 2024. [Blog Post](https://embracethered.com/blog/posts/2024/hiding-and-finding-text-with-unicode-tags/)

- **Robust Intelligence.** "Bypassing Meta's LLaMA Classifier: A Simple Jailbreak." 2024.
