...
If you want to **build custom scenarios** or understand the programming model behind scenarios, see the [Scenarios Programming Guide](../code/scenarios/0_scenarios.ipynb). For details on attack strategies, dataset configuration, and advanced programmatic usage, see [Working with Scenarios Programmatically](../code/scenarios/1_red_team_agent.ipynb).
