...
- Automated RAG Vulnerability Testing: Attackers can manipulate résumé content by injecting hidden text (via a [PDF converter](https://github.com/microsoft/PyRIT/blob/main/pyrit/prompt_converter/pdf_converter.py)) that optimizes scoring, influencing the AI Recruiter’s ranking system.
