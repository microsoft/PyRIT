...
_pre_alembic_migration_path = (
    Path(__file__).resolve().parent.parent.parent.parent
    / "pyrit" / "memory" / "alembic" / "versions"
    / "3b8f2c1a9d07_pre_alembic_release_schema.py"
)
_pre_alembic_spec = spec_from_file_location("pre_alembic_release_schema", _pre_alembic_migration_path)
_pre_alembic_mod = module_from_spec(_pre_alembic_spec)
_pre_alembic_spec.loader.exec_module(_pre_alembic_mod)
_CustomUUID = _pre_alembic_mod._CustomUUID
