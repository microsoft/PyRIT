...
class TestClassMetadata:
    ...
    def test_metadata_supported_auth_modes_projects_class_attribute(self, registry: TargetRegistry):
        # Entra-capable families expose both modes; api-key-only targets expose one.
        assert self._metadata_for(registry, "OpenAIChatTarget").supported_auth_modes == ("api_key", "entra")
    ...
    def test_metadata_supported_auth_modes_sourced_from_class_attributes(self, registry: TargetRegistry):
        ...
        assert meta.class_attributes["supported_auth_modes"] == ("api_key", "entra")
