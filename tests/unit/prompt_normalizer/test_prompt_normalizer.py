...
async def test_convert_audio_async_empty_pcm_returns_input(sqlite_instance):
    normalizer = PromptNormalizer()
...
async def test_convert_audio_async_chains_converters_and_returns_identifiers(sqlite_instance):
    normalizer = PromptNormalizer()
...
async def test_convert_audio_async_respects_data_type_filter(sqlite_instance):
...
async def test_convert_audio_async_rejects_mismatched_sample_rate(sqlite_instance):
