...
class TestSeedAttackTechniqueGroupFromSystemPrompt:
    ...
    def test_builds_single_system_general_technique_seed(self):
        ...
        group = SeedAttackTechniqueGroup.from_system_prompt("Follow these rules.")
    ...
    def test_preserves_literal_braces_without_rendering(self):
        ...
        group = SeedAttackTechniqueGroup.from_system_prompt("Decode this: {{ prompt }}")
    ...
    def test_respects_insertion_index(self):
        ...
        group = SeedAttackTechniqueGroup.from_system_prompt("s", insertion_index=0)
        assert group.insertion_index == 0
