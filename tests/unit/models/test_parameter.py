...
class TestParameterSerialization:
    ...
    def test_path_round_trips_with_live_type(self) -> None:
        ...
        assert restored.coerce_value("input.txt") == Path("input.txt")
...
class TestCoerceValueScalars:
    ...
    def test_path(self) -> None:
        p = Parameter(name="input_path", description="d", param_type=Path)
        assert p.coerce_value("input.txt") == Path("input.txt")
