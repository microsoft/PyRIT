...
def test_progress_maps_structured_adaptive_attempt_roles() -> None:
    ...
    mapped_child = ScenarioProgressReadModel._map_progress_delta(delta=child, plan_lookup=plan_lookup)
    mapped_envelope = ScenarioProgressReadModel._map_progress_delta(delta=envelope, plan_lookup=plan_lookup)
    mapped_invalid_index = ScenarioProgressReadModel._map_progress_delta(
